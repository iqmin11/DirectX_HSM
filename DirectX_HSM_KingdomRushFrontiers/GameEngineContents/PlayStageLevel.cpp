...
void PlayStageLevel::LoadPlayLevelAnimation()
{
	...
	GameEngineSprite::LoadFolder(Dir.GetPlusFileName("ArtilleryTower_Level4_Attack").GetFullPath());
	GameEngineSprite::LoadFolder(Dir.GetPlusFileName("ArtilleryTower_Level4_Idle").GetFullPath());
	...
	GameEngineSprite::LoadFolder(Dir.GetPlusFileName("Big_Explosion").GetFullPath());
